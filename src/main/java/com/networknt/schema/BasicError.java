...
public class BasicError implements Error {
    ...
    BasicError(String keyword, NodePath evaluationPath, SchemaLocation schemaLocation,
    ...
    public static abstract class BuilderSupport<S> {
        ...
        public Error build() {
            ...
            return new BasicError(keyword, evaluationPath, schemaLocation, instanceLocation,
