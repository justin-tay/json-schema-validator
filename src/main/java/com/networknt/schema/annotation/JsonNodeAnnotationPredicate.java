...
public class JsonNodeAnnotationPredicate implements Predicate<JsonNodeAnnotation> {
    ...
    final Predicate<JsonNodePath> schemaLocationPredicate;
    ...
    protected JsonNodeAnnotationPredicate(Predicate<JsonNodePath> instanceLocationPredicate,
            Predicate<JsonNodePath> evaluationPathPredicate, Predicate<JsonNodePath> schemaLocationPredicate,
     ...
     * @return the predicate
     */
    public Predicate<JsonNodePath> getSchemaLocationPredicate() {
    ...
    public static class Builder {
        ...
        Predicate<JsonNodePath> schemaLocationPredicate;
        ...
        public Builder schema(Predicate<JsonNodePath> schemaLocationPredicate) {
            this.schemaLocationPredicate = schemaLocationPredicate;
            return this;
        }
