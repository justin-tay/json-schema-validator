...
public class MaxItemsValidator extends BaseJsonValidator implements JsonValidator {
    ...
    public MaxItemsValidator(JsonNodePath schemaLocation, JsonNode schemaNode, JsonSchema parentSchema, ValidationContext validationContext) {
        super(schemaLocation, schemaNode, parentSchema, ValidatorTypeCode.MAX_ITEMS, validationContext);
