...
public class NetworkntTestSuiteBenchmark {
    ...
    public static class BenchmarkState {
        ...
        private Callable<Object> draft202012 = new NetworkntTestSuiteRunner(
                NetworkntTestSuiteTestCases.findTestCases(VersionFlag.V202012, "src/test/suite/tests/draft2020-12"));
        private Callable<Object> draft201909 = new NetworkntTestSuiteRunner(
                NetworkntTestSuiteTestCases.findTestCases(VersionFlag.V201909, "src/test/suite/tests/draft2019-09"));
        private Callable<Object> draft7 = new NetworkntTestSuiteRunner(
                NetworkntTestSuiteTestCases.findTestCases(VersionFlag.V7, "src/test/suite/tests/draft7"));
        private Callable<Object> draft6 = new NetworkntTestSuiteRunner(
                NetworkntTestSuiteTestCases.findTestCases(VersionFlag.V6, "src/test/suite/tests/draft6"));
        private Callable<Object> draft4 = new NetworkntTestSuiteRunner(
                NetworkntTestSuiteTestCases.findTestCases(VersionFlag.V4, "src/test/suite/tests/draft4"));
